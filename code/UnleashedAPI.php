...
class UnleashedAPI extends Object
{
    ...
    public static function set_settings($id, $key)
    {
        self::$id = $id;
        self::$key = $key;
    }
     ...
     */
    public static function post($class, $uID, $values, $format = null)
    {
     ...
     */
    public static function get($class, $filters = null)
    {
        $params = '';
        if (is_array($filters)) {
        ...
        try {
            ...
            } elseif (self::$format == 'xml') { // $result is an array or empty string
                if ($result == '') {
                    $result = false;
                } elseif (count($result) == 1) { // List of objects or no result
    ...
    public static function get_by_guid($class, $guid)
    {
        return self::get("$class/$guid");
    }

    public static function array2xml($array, $name)
    {
    ...
    public static function array2xmlRecursive(&$pointer, $array)
    {
