...
class UnleashedOrderDOD extends UnleashedObjectDOD
{
    ...
    public static $u_class = 'SalesInvoices';
    public static $unique_fields = array('OrderNumber', 'ID');

    public static $post_format = 'xml';

    public static $u_tax_guid;
    public static $attribute_tax_class;
    public static $exclude_attribute_classes = array();
